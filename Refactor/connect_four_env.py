...
class ConnectFourEnv:
    ...
    Args:
        ...
        connect_n: Number of pieces needed in a row to win [default: min(4, cols, rows) - automatically adjusts for small boards]
    """
    ...
    def make_move(self, col: int) -> Tuple[np.ndarray, float, bool, dict]:
        ...
        Returns:
            ...
            reward: Reward for the move (+1 win, 0 otherwise)
